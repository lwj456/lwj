...
def run_synthesis(in_dir: Path, out_dir: Path, syn_model_fpath: Path, hparams, existing_model):
    ...
    if existing_model is not None:
        print("Directly use an existing model.")
    ...
    print("Tacotron weights from step %d" % model.step)
