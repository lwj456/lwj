...
from run_wm_speech_pirate import g_speakers_seed_dic
...
def main():
    ...
    for tgt_name in speaker_names_lst:
        ...
        config = ExpSpeakerAdaptYourTTSCfg(
            ...
            tgt_audio_dic_lst=get_existing_wm_samples(tgt_name, out_dir.joinpath("ExpEmbedWatermark_Pirate")),
        ...
        exp_dir = out_dir.joinpath("ExpSpeakerAdaptYourTTS_Pirate")
