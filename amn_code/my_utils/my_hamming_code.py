"""
copied and modified https://github.com/dantrim/hamming-codec/blob/main/src/python/py_impl/utils.py
"""
...
def decode(binary_string: str, n_bits: int) -> str:
    ...
    # otherwise, this will raise exception
    if error_position > len(decoded_string):
        error_position = 0
